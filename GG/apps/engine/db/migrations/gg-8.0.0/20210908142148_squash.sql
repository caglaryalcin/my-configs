-- +goose Up
-- 20210713112630_Add_Prime_Mini_Wireless.sql

INSERT INTO devices(id, product_id, name, full_name, type, settings, undeployedsettings) VALUES (218, 272111690, 'prime_mini_wireless', 'Prime Mini Wireless', 1,
'{
	"batch_resolution": {
		"num_cpi_levels": 5,
...
INSERT INTO physical_devices(product_id, bootloader_product_id, name, full_name) values(272111690, 272111691, 'prime_mini_wireless', 'Prime Mini Wireless');
INSERT INTO physical_devices(product_id, bootloader_product_id, name, full_name) values(272111688, 272111689, 'prime_mini_wireless_dongle', 'Prime Mini Wireless Dongle');
INSERT INTO devices_to_physical_devices(physical_device_product_id, main_device_product_id) values(272111690, 272111690);
INSERT INTO devices_to_physical_devices(physical_device_product_id, main_device_product_id) values(272111688, 272111690);
